...
# NB: Django creates a special database for tests! :)
# source: https://docs.djangoproject.com/en/dev/intro/tutorial05/
...
class IndexedPageModelTest(TestCase):
    ...
    def test_synonyms_logic_invariant(self):
        ...
        other_google_urls = ["www.google.com", "https://www.google.com", "google.com", "http://google.com"]
